...
import gestionData from './categories.json';

const imageMapping = {
  gestion: require('../../assets/gestion.jpg'),
  Marketing: require('../../assets/gestion/Marketing.png'),
  RH: require('../../assets/gestion/RH.jpg'),
  Compta: require('../../assets/gestion/compta.png'),
  Entrepreunariat: require('../../assets/gestion/Entreupreunariat.jpg'),
  Leadership: require('../../assets/gestion/Leadership.jpg'),
};
const Gestion = () => {
  const navigation = useNavigation(); 

  const category = gestionData.categories[1];
